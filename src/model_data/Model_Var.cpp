...
Model_Var::Model_Var(const std::string& p_name,
    ...
    : m_name(p_name), m_idx(p_idx),
      m_upper_bound(p_requires_integrality ? k_default_integer_upper_bound
                                           : k_inf),
      m_lower_bound(k_default_lower_bound),
      m_type(p_requires_integrality ? Var_Type::binary : Var_Type::real),
      m_requires_integrality(p_requires_integrality)
{
}

Model_Var::~Model_Var() = default;
